...
# ApplicationRecord.transaction do 
    ...
    decorideas = User.create!({
      ...
      email: 'decor@user.io', 
      password: 'password',
      bio: 'We love to share our ideas about home decor'
    })
    ...
    cutepets = User.create!({username: 'cutepets', name: 'Love for pets', email: 'cutepets@gmail.com', password: 'ilovepets', bio: 'Cutepets is a community of pet lovers who share their love for pets'})
    ...
    appacademy = User.create!({username: 'appacademy', name: 'App Academy', email: 'admisions@appacademy.com', password: 'appacademyforver', bio: 'App Academy is a software engineering school in San Francisco, CA'})
    ...
    sflocations = User.create!({username: 'sflocations', name: 'SF Pictures', email: 'sfpics@gmail.com', password: 'sfbestcity', bio: 'Best pictures of San Francisco'})
    ...
    valenciaciudad = User.create!({username: 'valenciaciudad', name: 'Valencia', email: 'valencia@gmail.com', password: 'valenciaisbetterthansf', bio: 'Come to Valencia, the best city in Spain'})
    ...
    fcbarcelona = User.create!({username: 'fcbarcelona', name: 'FC Barcelona', email: 'fcbarcelona@gmail.com', password: 'bestteamever', bio: 'The best football team in the world'})
    ...
    stevejobs = User.create!({username: 'stevejobs', name: 'Steve Jobs', email: 'stevejobs@gmail.com', password: 'appleisbetterthansamsung', bio: 'Making the world a better place'})
    ...
    zarastore = User.create!(username: 'zarastore', name: 'Zara Store', email: 'zaraclothes@gmail.com', password: 'zaraclothes', bio: 'Clothing and accessories retailer')
  ...
  Follow.create!(follower_id: appacademy.id, followee_id: decorideas.id)
  Follow.create!(follower_id: appacademy.id, followee_id: cutepets.id)
  Follow.create!(follower_id: appacademy.id, followee_id: sflocations.id)

  Follow.create!(follower_id: sflocations.id, followee_id: decorideas.id)
  Follow.create!(follower_id: sflocations.id, followee_id: appacademy.id)

  Follow.create!(follower_id: valenciaciudad.id, followee_id: decorideas.id)
  Follow.create!(follower_id: valenciaciudad.id, followee_id: fcbarcelona.id)

  Follow.create!(follower_id: fcbarcelona.id, followee_id: decorideas.id)
  Follow.create!(follower_id: fcbarcelona.id, followee_id: valenciaciudad.id)

  Follow.create!(follower_id: stevejobs.id, followee_id: decorideas.id)
  Follow.create!(follower_id: stevejobs.id, followee_id: zarastore.id)

  Follow.create!(follower_id: zarastore.id, followee_id: stevejobs.id)
    ...
    post_7.photo.attach(io: URI.open('https://instapound-aa-dev.s3.us-west-1.amazonaws.com/computer1.jpg'), filename: 'computer1.jpg')
    post_7.save!
    ...
    post_10.photo.attach(io: URI.open('https://instapound-aa-dev.s3.us-west-1.amazonaws.com/dog-yellow.jpg'), filename: 'dog-yellow.jpg')
    post_10.save!
    ...
    post_2.photo.attach(io: URI.open('https://instapound-aa-dev.s3.us-west-1.amazonaws.com/steve-jobs-real.jpg'), filename: 'steve-jobs-real.jpg')
    post_2.save!
